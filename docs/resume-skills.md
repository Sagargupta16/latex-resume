...
All four are grounded in two sources of truth and must never fabricate:
...
3. **`cover-letter`** -- generate the company-specific letter.
4. **`recruiter-outreach`** -- draft the intro message linking the tailored resume.

## Guardrails shared by all four
